...
def test_missing_csv_columns_raise_clear_error() -> None:
    """
    Verifies that parsing a CSV missing required columns raises a clear ValueError.
    
    Attempts to parse CSV content that lacks the 'source_type' column and asserts a ValueError is raised with a message containing "missing required columns".
    """
